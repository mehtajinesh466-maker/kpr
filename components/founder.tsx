...
import { Quote, Award, Star, ChevronRight, Facebook, Linkedin } from "lucide-react";
    ...
    <section className="py-16 md:py-24 bg-slate-50 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          {/* LEFT: FOUNDER IMAGE (Vertical Pill Style) */}
          <motion.div 
          ...
          >
            {/* Technical Dot Grid Background - Responsive Visibility */}
            ...
            <div className="relative z-10 aspect-[3/4] rounded-full overflow-hidden border-[8px] md:border-[12px] border-white shadow-2xl shadow-slate-200">
               <Image 
                src="/anil.jpeg" 
                alt="M N Anilkumar - Founder"
                fill
            ...
            {/* FLOATING EXPERIENCE BADGE - Responsive sizes */}
            <motion.div 
              animate={{ y: [0, -10, 0] }}
          ...
          >
            ...
            <div className="relative text-center lg:text-left">
               ...
               <p className="text-lg md:text-2xl text-slate-600 font-medium leading-relaxed italic relative z-10">
                 &quot;Our mission at ChessEasy is to bridge the gap between passion and professional mastery. Every child has a king or queen within them; we simply provide the strategy to help them rule the board.&quot;
               </p>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 text-slate-500 font-medium leading-relaxed text-sm md:text-base text-center lg:text-left">
               <p>
                 With over a decade of dedication to the game, <strong className="text-slate-900 font-black italic">M N Anilkumar</strong> established ChessEasy Academy in Kottayam to bring International-level coaching to the doorsteps of aspiring players globally.
               </p>
               <p className="hidden md:block">
                 His vision drives our curriculum, ensuring that strategic intelligence, mental endurance, and the joy of the game remain at the core of everything we teach to our 2,000+ students.
               </p>
            </div>

            {/* CREDENTIALS PILLS - Flex wrap for responsiveness */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-2 md:gap-3">
               {["International Coach", "Strategic Expert", "Elite Mentor"].map((tag) => (
