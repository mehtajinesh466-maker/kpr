...
export function CoachesSection() {
  ...
  const coaches = [
    ...
    },
    {
      ...
      image: "/gab.png",
      accolades: [
        "Commonwealth Player (2018)",
        "MG University Team Champion (2016-19)",
        "Former Kerala U-17 Runner-up",
        "1st Runner-up in International FIDE Tournament"
      ],
      color: "bg-[#9C27B0]"
    },
    {
      name: "Vishnu Surendran",
      role: "Strategic Master",
      image: "/vis.png",
      accolades: [
        "Represented India in Commonwealth Championship (2012)",
        "Won SPIC International FIDE Rated Tournament (2011)",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center space-y-4 md:space-y-6 mb-12 md:mb-20">
          ...
          <p className="max-w-2xl mx-auto text-slate-500 font-medium text-sm md:text-lg leading-relaxed">
            Learn from the best. Our coaches are International FIDE rated players and 
            Commonwealth representatives with over a decade of competitive experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12">
          {coaches.map((coach, idx) => (
            <motion.div
              ...
              className="group bg-slate-50 rounded-[3rem] md:rounded-[4rem] p-4 pb-10 md:pb-12 border border-slate-100 hover:bg-white hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-500 flex flex-col"
            >
              ...
              <div className="px-4 md:px-6 space-y-6 flex-grow">
                <div className="text-center">
                  ...
                  <div className="w-10 h-1 bg-[#FFB800] mx-auto rounded-full group-hover:w-20 transition-all duration-500" />
                </div>
                ...
                <div className="space-y-3 pt-2">
                  {coach.accolades.map((text, i) => (
                    <div key={i} className="flex items-start gap-3 group/item">
                      <div className={`mt-1 w-5 h-5 rounded-lg flex items-center justify-center shrink-0 ${coach.color} text-white shadow-sm group-hover/item:scale-110 transition-transform`}>
                         <Award size={12} />
                      </div>
        ...
        >
          <Link href="/contact" className="w-full sm:w-auto">
            <button className="w-full bg-slate-900 text-white px-8 md:px-12 py-4 md:py-5 rounded-full font-black text-xs md:text-sm hover:bg-black transition-all shadow-xl active:scale-95 flex items-center justify-center gap-4 group">
