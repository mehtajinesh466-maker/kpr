...
import { ChevronRight, Target, Brain, Globe } from "lucide-react";
    ...
    <>
      <section className="relative w-full h-[80vh] md:h-[90vh] flex items-center justify-center overflow-hidden bg-[#020617] font-sans">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/bg3.jpg" // Replace with an academy or strategy themed chess image
        ...
        <div className="absolute inset-0 pointer-events-none hidden lg:block">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-white font-bold text-xs uppercase tracking-tight">Performance Labs</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-white font-bold text-xs uppercase tracking-tight">Strategic Mind</p>
            </div>
          </motion.div>
