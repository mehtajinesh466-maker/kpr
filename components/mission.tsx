      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center space-y-4 md:space-y-6 mb-12 md:mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 md:px-6 md:py-2 rounded-full bg-slate-50 border border-slate-100 shadow-sm">
            <Rocket size={14} className="text-[#FFB800]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 md:mb-20">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="group relative bg-[#0A0F1C] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-16 overflow-hidden shadow-2xl border-4 border-white"
          >
            {/* Background Pattern */}
            ...
            <div className="relative z-10 space-y-6 md:space-y-8">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] md:rounded-[2rem] bg-[#FFB800] flex items-center justify-center text-black shadow-lg shadow-amber-500/20 group-hover:rotate-6 transition-transform duration-500">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-base md:text-lg leading-relaxed font-medium">
                  To provide <span className="text-white">structured, world-class coaching</span> globally. We democratize elite training, nurturing the strategic thinking required to create champions.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4 text-[#FFB800] font-black text-[10px] uppercase tracking-[0.2em]">
                 ...
                 Creating Global Grandmasters
              </div>
            </div>
          </motion.div>

          {/* VISION CARD (Yellow Style) */}
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="group relative bg-[#FFB800] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-16 overflow-hidden shadow-2xl border-4 border-white"
          >
            <div className="relative z-10 space-y-6 md:space-y-8">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] md:rounded-[2rem] bg-slate-900 flex items-center justify-center text-[#FFB800] shadow-lg group-hover:-rotate-6 transition-transform duration-500">
                <Eye size={32} className="md:w-10 md:h-10" />
              </div>
              
              <div className="space-y-4">
                {/* Heading: 3xl Mobile / 5xl Desktop */}
                <h3 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                  Our <span className="text-white italic">Vision</span>
                </h3>
                <p className="text-slate-800 text-base md:text-lg leading-relaxed font-bold">
                  To become the world&apos;s most trusted destination for chess excellence. We envision a global community connected through the timeless art of strategic play.
                </p>
              </div>

              <div className="flex items-center gap-4 text-slate-900/60 font-black text-[10px] uppercase tracking-[0.2em]">
                 <span className="w-8 md:w-12 h-px bg-slate-900/10" />
        ...
        >
            ...
            <button className="group w-full md:w-auto flex items-center justify-center gap-4 bg-[#FFB800] hover:bg-[#FFA500] text-black px-8 md:px-10 py-4 md:py-5 rounded-full font-black text-[10px] md:text-xs uppercase tracking-widest transition-all active:scale-95 shadow-xl shadow-amber-500/10">
                Join our mission
