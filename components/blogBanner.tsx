    ...
    <>
      <section className="relative w-full h-[80vh] md:h-[90vh] flex items-center justify-center overflow-hidden bg-[#020617] font-sans">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/chess-blog.jpg" // Replace with a library or study-themed chess image
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center -mt-10 md:-mt-24">
          ...
          >
            <div className="flex items-center gap-3 text-[11px] font-black tracking-[0.3em] uppercase">
              ...
              <span className="text-[#FFB800]">Insights</span>
            </div>
          </motion.div>
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-[90px] font-black tracking-tighter leading-none uppercase flex items-center justify-center">
              ...
              <span className="text-[#FFB800] not-italic ml-3">INSIGHTS.</span>
            </h1>
            <p className="text-slate-300 font-bold uppercase tracking-[0.3em] md:tracking-[0.5em] text-[10px] md:text-xs max-w-4xl mx-auto leading-relaxed">
              Strategic <span className="text-white">Analysis</span>, Mental Endurance <br className="hidden md:block" />
              & The Science of ChessEasy Performance.
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none hidden lg:block">
          ...
          >
            <div className="p-3 bg-white/5 border border-white/10 rounded-2xl">
              <BookOpen className="text-[#FFB800] w-6 h-6" />
            </div>
            <div className="text-left">
              <p className="text-white/40 text-[8px] font-black uppercase tracking-widest leading-none mb-1">Knowledge Base</p>
              <p className="text-white font-bold text-xs uppercase tracking-tight">Curated Data</p>
            </div>
          </motion.div>

          {/* LEFT BOTTOM: COGNITIVE */}
          <motion.div 
            animate={{ y: [0, 12, 0] }}
          ...
          >
            ...
            <div className="text-left">
              <p className="text-white/40 text-[8px] font-black uppercase tracking-widest leading-none mb-1">Topic</p>
              <p className="text-white font-bold text-xs uppercase tracking-tight">Cognitive Labs</p>
            </div>
          </motion.div>

          {/* RIGHT: WEEKLY ANALYSIS */}
          <motion.div 
            animate={{ y: [0, -15, 0] }}
          ...
          >
            <div className="p-3 bg-white/5 border border-white/10 rounded-2xl">
              <Zap className="text-[#FFB800] w-6 h-6" />
            </div>
            <div className="text-left">
              <p className="text-white/40 text-[8px] font-black uppercase tracking-widest leading-none mb-1">Frequency</p>
              <p className="text-white font-bold text-xs uppercase tracking-tight">Weekly Strategy</p>
            </div>
          </motion.div>
        </div>
